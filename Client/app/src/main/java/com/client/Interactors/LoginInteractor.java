...
public class LoginInteractor implements LoginContract.LoginInteractor {
    ...
    @Override
    public void loginCall(User user, Context context, OnLoginListener onLoginListener) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, ConnectionConstans.API_URL + "user/login", jsonObject,
